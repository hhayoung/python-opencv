...
# 허프변환 원 검출 함수
circles = cv2.HoughCircles(blur, cv2.HOUGH_GRADIENT, 1, 50, param1=250, param2=40, minRadius=50, maxRadius=120) # 파라미터들 테스트 필요
...
if circles is not None:
    ...
    for i in range(circles.shape[1]): # 동전 갯수만큼 shape=(1,N,3)
        ...
        # Hue 평균 > 142보다 크면 500원으로 간주
        # Hue 평균 < 142보다 작으면 100원으로 간주
        # Hue 평균 < 60보다 작으면 10원으로 간주
